...
internal static class MessageFailureReport
{
    ...
    internal static void ProcessMessageFailureReports(string importDir, string tmpDir)
    {
        ...
        ReportProcessor.ProcessExcelFiles(importDir, "*Message_Failure*.xlsx", (worksheet, sheetName) =>
        {
